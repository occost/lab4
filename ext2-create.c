...
void write_block_bitmap(int fd) {
    ...
    // Padding the remaining bits to indicate blocks are not free
...
void write_inode_bitmap(int fd) {
    ...
    // Padding the remaining bits to indicate inodes are not free
...
void write_hello_world_file_block(int fd) {
    ...
    if (write(fd, hello_world_content, sizeof(hello_world_content)) != sizeof(hello_world_content)) {
        errno_exit("write");
    }
}
